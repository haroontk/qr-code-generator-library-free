# Codeword capacity of all versions of QR code

| Version  V | Modules per side  A | Function pattern modules  B | Format & version info modules  C | Data modules (excl. function patterns)  D | Data capacity (codewords)  E | Remainder bits  R |
|-|-|-|-|-|-|-|
| M1 | 11  | 70   | 15 | 36    | 5    | 0 |
| M2 | 13  | 74   | 15 | 80    | 10   | 0 |
...
$$A^2 = B +C +D$$
$$8E + R = D \quad \text{(except M1 and M3, which has 4 bit codeword)}$$
$$A = 4V + 17 \quad \text{(for QR Codes)}$$
$$A = 2V + 9 \quad \text{(for micro QR Codes)}$$